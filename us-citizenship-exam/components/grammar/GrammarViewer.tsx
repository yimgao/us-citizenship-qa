      ...
      <div className="relative mb-6">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col rounded-2xl border-2 border-green-200 bg-gradient-to-br from-green-50 to-white p-6 [backface-visibility:hidden] [transform:rotateY(180deg)] overflow-y-auto">
